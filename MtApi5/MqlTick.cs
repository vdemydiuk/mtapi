...
namespace MtApi5
{
    ...
    {
        public MqlTick(DateTime time, double bid, double ask, double last, ulong volume, uint flags)
        {
        ...
        public uint flags { get; set; }   // Volume for the current Last price with greater accuracy 
